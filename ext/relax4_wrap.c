...
SWIGINTERN IntegerArray *new_IntegerArray(size_t nelements){
    return (long int *)malloc((nelements)*sizeof(long int));
  }
SWIGINTERN long IntegerArray___getitem__(IntegerArray *self,size_t index){
    return self[index];
  }
...
SWIGINTERN void IntegerArray___setitem__(IntegerArray *self,size_t index,long value){
    self[index] = value;
  }
SWIGINTERN long *IntegerArray_cast(IntegerArray *self){
    return self;
  }
SWIGINTERN IntegerArray *IntegerArray_frompointer(long *t){
...
_wrap_IntegerArray___getitem__(int argc, VALUE *argv, VALUE self) {
  ...
  arg2 = (size_t)(val2);
  result = (long)IntegerArray___getitem__(arg1,arg2);
...
_wrap_IntegerArray_cast(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = (IntegerArray *)(argp1);
  result = (long *)IntegerArray_cast(arg1);
...
_wrap_IntegerArray_frompointer(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "long *","IntegerArray_frompointer", 1, argv[0] )); 
  }
  arg1 = (long *)(argp1);
...
static void *_p_IntegerArrayTo_p_long(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((long *)  ((IntegerArray *) x));
}
static swig_type_info _swigt__p_IntegerArray = {"_p_IntegerArray", "struct IntegerArray *|IntegerArray *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_long = {"_p_long", "long *|integer *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_unsigned_long = {"_p_unsigned_long", "unsigned long *|uinteger *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_long[] = {  {&_swigt__p_long, 0, 0, 0},  {&_swigt__p_IntegerArray, _p_IntegerArrayTo_p_long, 0, 0},{0, 0, 0, 0}};
...
SWIGEXPORT void Init_relax4(void) {
  ...
  rb_define_module_function(mRelax4, "run_relax4", _wrap_run_relax4, -1);
}
